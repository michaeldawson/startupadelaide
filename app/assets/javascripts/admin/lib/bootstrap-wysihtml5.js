!function($, wysi) {
    ...
    var Wysihtml5 = function(el, options) {
        ...
        jQuery('iframe.wysihtml5-sandbox').each(function(i, el){
            jQuery(el.contentWindow).off('focus.wysihtml5').on({
    ...
    Wysihtml5.prototype = {
        ...
        initInsertImage: function(toolbar) {
            ...
            toolbar.find('a[data-wysihtml5-command=insertImage]').click(function() {
                var activeButton = jQuery(this).hasClass("wysihtml5-command-active");
    ...
    var methods = {
        ...
        shallowExtend: function (options) {
            var settings = $.extend({}, $.fn.wysihtml5.defaultOptions, options || {}, jQuery(this).data());
            var that = this;
