...
var App = function () {
    ...
    var handleFixedSidebarHoverable = function () {
        ...
        jQuery('.page-sidebar').off('mouseenter').on('mouseenter', function () {
            ...
            if (body.hasClass("page-sidebar-reversed")) {
                jQuery(this).width(sidebarWidth);
            } else {
        ...
        jQuery('.page-sidebar').off('mouseleave').on('mouseleave', function () {
            ...
            if (body.hasClass("page-sidebar-reversed")) {
                ...
                jQuery(this).width(sidebarCollapsedWidth);
            } else {
                jQuery(this).addClass('page-sidebar-hovering');
                jQuery(this).animate({
    ...
    var handleSidebar = function (color) {
        ...
        jQuery(document).mousemove(function (e) {
           //jQuery("body").on("mousemove", function(mouse_pointer) {
           //console.log(mouse_pointer.pageX - jQuery(window).scrollLeft());
           //mouse_position = mouse_pointer.pageX - jQuery(window).scrollLeft();
           if (animating) {
               return;
           }
           mouse_position = e.clientX;

           if (mouse_position <= 50) {
               //SLIDE IN MENU
               animating = true;
               jQuery('#cms_bar').animate({
                   left: 0,
                   opacity: 1
               }, 200, function () {
                   animating = false;
    ...
    var handleScroll = function() {
        jQuery(".scroll").click(function(event){
            ...
            var target_top = target_offset.top+1;

            jQuery('html, body').animate({scrollTop:target_top}, 1400);
        });
    }
    ...
    return {
        ...
        init: function () {
            ...
            handleScroll(); // setup scroll links
